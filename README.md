...
- **CLI версия** - Мощный инструмент командной строки для автоматизации и пакетной обработки
- **WEB версия** - Современное веб-приложение с drag-and-drop интерфейсом ([см. web/README.md](web/README.md))
