...
### v2.1.0 (2024-11-18)
- ✅ Полная переработка генерации PDF с академическим стилем
- ✅ Поддержка кириллицы через шрифт Helvetica
- ✅ Таблицы с границами в PDF (jsPDF-AutoTable)
- ✅ Mermaid диаграммы в PDF с автомасштабированием
- ✅ Заголовки H1 начинаются с новой страницы
- ✅ Диаграммы помещаются на одной странице
- ✅ Удален выбор стиля (всегда профессиональный)
- ✅ Шрифт Helvetica 12pt, поля 25mm
- ✅ Система версионирования

### v2.0.0 (2024-11)
- Первая статическая версия
- Конвертация MD в PDF и DOCX
- Поддержка синтаксиса, таблиц, диаграмм
