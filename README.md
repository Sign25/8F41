...
3. Выберите branch: `main`, folder: `/web-static`
4. Сохраните
...
- [CLI версия](../README.md)
- [Серверная веб-версия](../web/README.md)
- [Демо](https://yourusername.github.io/md/) - замените на ваш URL

## 💡 Альтернативы

Если вам нужна более мощная обработка:
- Используйте **CLI версию** для автоматизации
- Используйте **серверную веб-версию** для больших файлов
- Используйте [Pandoc](https://pandoc.org) для максимальной гибкости
